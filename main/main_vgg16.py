...
feature_list = np.array(pickle.load(open('embeddingsdensenet.pkl','rb')))
filenames = pickle.load(open('filenamesdensenet.pkl','rb'))
...
def feature_extraction(img_path,model):
    ...
    preprocessed_img = preprocess_input_densenet(expanded_img_array)
